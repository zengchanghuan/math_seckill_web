  ...
  return (
    <div className="w-full">
      ...
      <div className="mt-2 text-[14px] leading-[24px] text-[#62748E]">
        输入 Import ID 进入校对编辑器（Figma 2:1155）。
      </div>

      <div className="mt-6 max-w-[520px] rounded-[14px] border border-[#E2E8F0] bg-white p-6 shadow-[0px_1px_3px_0px_rgba(0,0,0,0.1),0px_1px_2px_-1px_rgba(0,0,0,0.1)]">
        ...
        <input
          ...
          placeholder="例如：imp_xxx 或 IMP-001"
